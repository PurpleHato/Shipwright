...
void Randomizer::CreateCustomMessages() {
    ...
    const std::vector<GetItemMessage> getItemMessages = {
        GIMESSAGE_NO_GERMAN(RG_PROGRESSIVE_BOMB_BAG, ITEM_BOMB_BAG_20, 
            "You found a %rBomb Bag%w!&If you see something&suspicious, bomb it!", 
            "You found a %rBomb Bag%w!&If you see something&suspicious, bomb it!",  
            "Vous obtenez un %rSac de &Bombes%w!"),
        GIMESSAGE_NO_GERMAN(RG_PROGRESSIVE_BOW, ITEM_BOW, 
            "You found the %rFairy Bow%w!", 
            "You found the %rFairy Bow%w!", 
            "Vous obtenez l'%rArc des Fées%w!"),
        GIMESSAGE_NO_GERMAN(RG_FIRE_ARROWS, ITEM_ARROW_FIRE, 
        ...
        GIMESSAGE_NO_GERMAN(RG_ICE_ARROWS, ITEM_ARROW_ICE, 
        ...
        GIMESSAGE_NO_GERMAN(RG_LIGHT_ARROWS, ITEM_ARROW_LIGHT, 
        ...
        GIMESSAGE_NO_GERMAN(RG_DINS_FIRE, ITEM_DINS_FIRE, 
        ...
        GIMESSAGE_NO_GERMAN(RG_FARORES_WIND, ITEM_FARORES_WIND, 
        ...
        GIMESSAGE_NO_GERMAN(RG_NAYRUS_LOVE, ITEM_NAYRUS_LOVE, 
        ...
        GIMESSAGE_NO_GERMAN(RG_PROGRESSIVE_SLINGSHOT, ITEM_SLINGSHOT, 
            "You found the %rFairy Slingshot%w!", 
            "You found the %rFairy Slingshot%w!", 
            "Vous obtenez %rLance-Pierre&des Fées!%w!"),
        GIMESSAGE_NO_GERMAN(RG_PROGRESSIVE_OCARINA, ITEM_OCARINA_FAIRY, 
        ...
        GIMESSAGE_NO_GERMAN(RG_PROGRESSIVE_OCARINA, ITEM_OCARINA_TIME, 
        ...
        GIMESSAGE_NO_GERMAN(RG_PROGRESSIVE_BOMBCHUS, ITEM_BOMBCHU, 
            "", 
            "", 
            ""),
        GIMESSAGE_NO_GERMAN(RG_PROGRESSIVE_HOOKSHOT, ITEM_HOOKSHOT, 
        ...
        GIMESSAGE_NO_GERMAN(RG_BOOMERANG, ITEM_BOOMERANG, 
            "You found the %rBoomerang%w!", 
            "You found the %rBoomerang%w!", 
            "Vous obtenez le %rBoomreang%w!"),
        GIMESSAGE_NO_GERMAN(RG_LENS_OF_TRUTH, ITEM_LENS, 
        ...
        GIMESSAGE_NO_GERMAN(RG_MEGATON_HAMMER, ITEM_HAMMER, 
        ...
        GIMESSAGE_NO_GERMAN(RG_PROGRESSIVE_STRENGTH, ITEM_BRACELET, 
        ...
        GIMESSAGE_NO_GERMAN(RG_PROGRESSIVE_STRENGTH, ITEM_GAUNTLETS_SILVER, 
        ...
        GIMESSAGE_NO_GERMAN(RG_PROGRESSIVE_STRENGTH, ITEM_GAUNTLETS_GOLD, 
        ...
        GIMESSAGE_NO_GERMAN(RG_PROGRESSIVE_SCALE, ITEM_SCALE_SILVER, 
        ...
        GIMESSAGE_NO_GERMAN(RG_PROGRESSIVE_SCALE, ITEM_SCALE_GOLDEN, 
        ...
        GIMESSAGE_NO_GERMAN(RG_KOKIRI_SWORD, ITEM_SWORD_KOKIRI, 
        ...
        GIMESSAGE_NO_GERMAN(RG_BIGGORON_SWORD, ITEM_SWORD_BGS, 
            "You got the %rBiggoron's Sword%w!&This blade was forged by a &master smith and won't break!",
            "You got the %rBiggoron's Sword%w!&This blade was forged by a &master smith and won't break!",
            ""),
        GIMESSAGE_NO_GERMAN(RG_DEKU_SHIELD, ITEM_SHIELD_DEKU, 
            "You got a %cDeku Shield%w!",
            "You got a %cDeku Shield%w!",
            "Vous obtenez un %cBouclier&Mojo!"),
        GIMESSAGE_NO_GERMAN(RG_HYLIAN_SHIELD, ITEM_SHIELD_HYLIAN, 
            "You got a %cHylian Shield%w!",
            "You got a %cHylian Shield%w!",
            "Vous obtenez un %cBouclier&Hylien%w!"),
        GIMESSAGE_NO_GERMAN(RG_MIRROR_SHIELD, ITEM_SHIELD_MIRROR, 
        ...
        GIMESSAGE_NO_GERMAN(RG_HOVER_BOOTS, ITEM_BOOTS_HOVER, 
...
void InitRandoItemTable() {
    ...
    static GetItemEntry extendedVanillaGetItemTable[] = {
        GET_ITEM(ITEM_MEDALLION_LIGHT,                 OBJECT_GI_MEDAL,    GID_MEDALLION_LIGHT,  TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_RANDOMIZER,       RG_LIGHT_MEDALLION),
        GET_ITEM(ITEM_MEDALLION_FOREST,                OBJECT_GI_MEDAL,    GID_MEDALLION_FOREST, TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_RANDOMIZER,       RG_FOREST_MEDALLION),
        GET_ITEM(ITEM_MEDALLION_FIRE,                  OBJECT_GI_MEDAL,    GID_MEDALLION_FIRE,   TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_RANDOMIZER,       RG_FIRE_MEDALLION),
        GET_ITEM(ITEM_MEDALLION_WATER,                 OBJECT_GI_MEDAL,    GID_MEDALLION_WATER,  TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_RANDOMIZER,       RG_WATER_MEDALLION),
        GET_ITEM(ITEM_MEDALLION_SHADOW,                OBJECT_GI_MEDAL,    GID_MEDALLION_SHADOW, TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_RANDOMIZER,       RG_SHADOW_MEDALLION),
        GET_ITEM(ITEM_MEDALLION_SPIRIT,                OBJECT_GI_MEDAL,    GID_MEDALLION_SPIRIT, TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_RANDOMIZER,       RG_SPIRIT_MEDALLION),

        GET_ITEM(ITEM_KOKIRI_EMERALD,                  OBJECT_GI_JEWEL,    GID_KOKIRI_EMERALD,   TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_RANDOMIZER,       RG_KOKIRI_EMERALD),
        GET_ITEM(ITEM_GORON_RUBY,                      OBJECT_GI_JEWEL,    GID_GORON_RUBY,       TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_RANDOMIZER,       RG_GORON_RUBY),
        GET_ITEM(ITEM_ZORA_SAPPHIRE,                   OBJECT_GI_JEWEL,    GID_ZORA_SAPPHIRE,    TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_RANDOMIZER,       RG_ZORA_SAPPHIRE),
