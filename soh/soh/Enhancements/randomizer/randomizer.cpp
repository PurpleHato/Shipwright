...
std::string FormatJsonHintText(std::string jsonHint) {
    ...
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', aSpeCap1);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', iSpeLow);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', aSpeCap2);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', aSpeCap3);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', cSpeCap);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', eSpeCap1);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', eSpeCap2);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', eSpeCap3);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', eSpeCap4);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', iSpeCap);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', oSpeCap1);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', oSpeCap2);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', uSpeCap1);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', uSpeCap2);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', uSpeCap3);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', bSpeGer3);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', aSpeLow1);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', aSpeLow2);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', aSpeLow3);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', aSpeLow4);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', cSpeLow);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', eSpeLow1);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', eSpeLow2);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', eSpeLow3);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), 'U+00E8è', eSpeLow4);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', iSpeLow2);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', oSpeLow1);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', oSpeLow2);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', uSpeLow1);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', uSpeLow2);
    // std::replace(formattedHintMessage.begin(), formattedHintMessage.end(), '�', uSpeLow3);
